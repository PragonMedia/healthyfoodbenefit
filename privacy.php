...
<body>
    ...
    <p>
        <span id="website-name"><?= $domain ?></span> ("Company," "we,"
        "our," or "us") values your privacy. This Privacy Policy explains how we
        collect, use, and protect your personal information when you use our
        website <span id="domain-name"><?= $domain ?></span> and related
    ...
    <p>
        To exercise your rights, contact us at support@<?= $domain ?>.
    </p>
    ...
    <p>
        ...
        <span id="country">United States</span>, your information may be
